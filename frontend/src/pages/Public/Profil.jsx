...
const Profil = () => {
    ...
    return (
        <div className="pt-24 pb-16 px-margin-mobile md:px-margin-desktop bg-[#FAFDFB]">
            {/* Header section with gradient background card */}
            <div className="max-w-4xl mx-auto mb-lg relative overflow-hidden rounded-2xl bg-gradient-to-r from-[#005440] to-[#0A7C5F] text-white p-lg md:p-xl shadow-md">
            ...
            <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-lg items-start">
                
                {/* Left Panel: Circular Profile Picture & General Info */}
                <div className="bg-white rounded-2xl border border-[#D1FAE5] shadow-sm p-lg flex flex-col items-center text-center space-y-md">
                    <div className="relative group cursor-pointer" onClick={triggerFileSelect}>
                        {/* Circle Avatar Wrapper */}
                        <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-[#005440]/10 bg-[#005440]/5 flex items-center justify-center shadow-inner relative transition-transform duration-300 group-hover:scale-105">
                            {fotoPreview ? (
                                <img 
                                    src={fotoPreview} 
                                    alt="Foto Profil" 
                            ...
                            <div className="absolute inset-0 bg-[#005440]/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-center justify-center text-white">
                        ...
                        <div className="absolute bottom-1 right-1 bg-[#005440] text-white p-xs rounded-full shadow-md flex items-center justify-center border border-white hover:bg-[#0A7C5F] transition-colors">
                ...
                <div className="bg-white rounded-2xl border border-[#D1FAE5] shadow-sm p-lg md:col-span-2">
                    <form onSubmit={handleSubmit} className="space-y-lg">
                        ...
                        <div className="flex items-center gap-xs border-b border-outline-variant pb-xs">
                            ...
                            <h4 className="font-title-lg text-title-lg text-primary font-bold">Informasi Pribadi</h4>
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-md">
                            <div className="relative border border-outline-variant rounded-lg focus-within:border-primary focus-within:ring-1 focus-within:ring-primary transition-all">
                                ...
                                <input 
                                    ...
                                    className="w-full bg-transparent border-none focus:ring-0 text-body-lg font-body-lg text-on-surface p-md rounded-lg" 
                                    type="text" 
                        ...
                        <div className="flex items-center gap-xs border-b border-outline-variant pb-xs pt-md">
                            <span className="material-symbols-outlined text-[#005440]">security</span>
                            <h4 className="font-title-lg text-title-lg text-primary font-bold">Keamanan & Sandi</h4>
                        </div>
                        <p className="font-label-md text-label-md text-on-surface-variant">Kosongkan kolom di bawah ini jika Anda tidak ingin merubah kata sandi login saat ini.</p>
                        ...
                        <div className="pt-lg border-t border-outline-variant flex justify-end">
                            <button 
                                type="submit" 
                                disabled={loading} 
                                className="px-lg py-md rounded-lg btn-primary text-white font-title-md shadow-md flex items-center gap-xs disabled:opacity-50 hover:shadow-lg transition-all transform active:scale-95 duration-200"
                            >
